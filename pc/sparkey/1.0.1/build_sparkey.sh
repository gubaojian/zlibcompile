...
export CFLAGS="${CFLAGS} -O3  -Wall -Wno-error -Wno-strict-prototypes -I/opt/homebrew/include"
export CXXFLAGS="${CXXFLAGS} -O3  -Wall -Wno-error -Wno-strict-prototypes  -I/opt/homebrew/include"
