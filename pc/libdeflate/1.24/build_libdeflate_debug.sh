...
DOWNLOAD_URL="https://github.com/ebiggers/libdeflate/archive/refs/tags/v${1.24}.tar.gz"
...
cmake .. -DCMAKE_INSTALL_PREFIX=$INSTALL_DIR -DCMAKE_INSTALL_DO_STRIP=OFF -DCMAKE_BUILD_TYPE=Debug -DCMAKE_C_FLAGS="-g -O0" 
cmake --build . -j12
cmake --install .
