...
DOWNLOAD_URL="https://github.com/google/snappy/archive/refs/tags/${VERSION}.tar.gz"
...
##  -DBUILD_TESTING=OFF
 mkdir build
 cd build
 cmake  -DCMAKE_BUILD_TYPE=Release -DSNAPPY_BUILD_TESTS=OFF -DSNAPPY_BUILD_BENCHMARKS=OFF -DCMAKE_INSTALL_PREFIX=$INSTALL_DIR  ..
 make -j12
 make install
 cd ..
